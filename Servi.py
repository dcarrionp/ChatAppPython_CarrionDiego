...
import pyperclip  # Librería para manejar el portapapeles (debes instalarla con `pip install pyperclip`)
...
class Servidor:
    def __init__(self, host="localhost", port=4000):
        ...
        # Botones y clave en el lado izquierdo
        button_frame = tk.Frame(self.window, bg="#1E1E2E")
        button_frame.grid(row=0, column=0, padx=10, pady=10, sticky="ns")

        # Clave Fernet
        self.key_label = tk.Label(button_frame, text="Clave Fernet:", bg="#1E1E2E", fg="white", font=font_style)
        self.key_label.grid(row=0, column=0, padx=5, pady=5, sticky="w")

        self.key_entry = tk.Entry(button_frame, fg="blue", bg="#2E2E3E", width=25, font=font_style)
        ...
        self.copy_button = Button(button_frame, text="Copiar Clave", command=self.copy_key,
                                  font=button_font, bg="#FFD700", fg="black", width=20)
    ...
    def copy_key(self):
        """Copia la clave Fernet al portapapeles."""
